...
1. Export a JSON of your material from [FModel](https://github.com/WistfulHopes/FModel).
...
1. Export the JSON and binary form of the shader archive from [FModel](https://github.com/WistfulHopes/FModel).
